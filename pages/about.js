...
const AboutPage = () => {
    return(
        ...
        <p>
            Maybe it's the MidWest in me, but I love to share favorites and relate to people through that passion. My favorite movie is and always will be <Link href='https://www.youtube.com/watch?v=n14e2u35rUU'>Point Break</Link>. My top three books are <Link href='//www.goodreads.com/book/show/412732.The_Dharma_Bums'>Dharma Bums</Link>, <Link href='//www.goodreads.com/book/show/76334.A_New_Earth'>A New Earth</Link>, and <Link href='//www.garthstein.com/works/the-art-of-racing-in-the-rain/'>The Art of Racing in the Rain</Link>. My favorite sports are Football, MMA, Chess, Surfing, and Basketball. A few more of my favorite things include riding motorcycles, doing yoga, walking my dog with my woman, adventuring with friends, and cooking. I hope that after you read this we can connect and you'll share your favorites with me!
        </p>
        <p>
            My purpose in this life is to share my voice and experiences, and open up my ears and heart to hear the voice and experiences of others. I do that by combining three things that I truly love: performing stand-up comedy, hosting a podcast (<Link href='//podcasts.apple.com/us/podcast/the-kyle-kelley-show/id1517902299'>The Kyle Kelley Show</Link>), and web development. 
        </p>
        <p>
